...
let favorite_fruits:string[] = ['Pomegranate','Guava','Apple','Black Current','Grapes']
let a:string = favorite_fruits[0]
let b:string = favorite_fruits[1]
let c:string = favorite_fruits[2]
let d:string = favorite_fruits[3]
let e:string = favorite_fruits[4]
